...
def getTrainBatch():
    ...
    for i in range(batch_size):
        if (i % 2 == 0):
            ...
            # 22499, those will be used for tests
            num = randint(12500, 23500)
            labels.append([0, 1])
...
def getTestBatch():
    ...
    for i in range(batch_size):
        if (i % 2 == 0):
            # 12499
            num = randint(11501, 12499)
            labels.append([1, 0])
        else:
            # 22499, those will be used for tests
            num = randint(23501, 24999)
            labels.append([0, 1])
        arr[i] = training_data[num]
    return arr, labels
